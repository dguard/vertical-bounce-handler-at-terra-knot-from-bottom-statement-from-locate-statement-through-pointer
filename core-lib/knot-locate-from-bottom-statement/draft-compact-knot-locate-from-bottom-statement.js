...
function PointerBelongingsAtKnotFromBottomStatement() {
    ...
    that.useKnotRelativeSize = function (knotRelativeSize) {
        pointerBelongingsAtKnotRelativeSize = knotRelativeSize.pointerBelongings
    }
    ...
    that.compute = function () {
        ...
        let fromBottomStatement = knotInstance.throughKnot.fromBottomStatement
        console.log(fromBottomStatement)
        process.exit()
        ...
        that.pointerBelongings = {
            ...
            knotAtDistanceY: (that.descendingFromTheSun([knotInstance.throughKnot.fromBottomStatement.pointerBelongingsAtTopLeft.y, knotInstance.pointerBelongingsAtBottomLeft.y]) - knotInstance.throughKnot.fromBottomStatement.pointerBelongingsAtTopLeft.y),
            // that's human style
            knotAtDistanceX: (knotInstance.throughKnot.fromBottomStatement.pointerBelongingsAtBottomLeft.x - knotInstance.throughKnot.fromBottomStatement.pointerBelongingsAtBottomRight.x),
            knotRelativeSizeAtFront: (pointerBelongingsAtKnotRelativeSize.pointerBelongingsAtBottomLeft - pointerBelongingsAtKnotRelativeSize.pointerBelongingsAtBottomRight),
            knotRelativeSizeAtDebth: (that.descendingFromTheSun([pointerBelongingsAtKnotRelativeSize.pointerBelongingsAtTopLeft, pointerBelongingsAtKnotRelativeSize.pointerBelongingsAtBottomLeft]) - pointerBelongingsAtKnotRelativeSize.pointerBelongingsAtTopLeft),
