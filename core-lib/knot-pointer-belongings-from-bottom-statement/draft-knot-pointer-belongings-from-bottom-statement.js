...
// is it gorgylua?
let throughX
for(let fromTry = 1, knotWi = originalSpawnedPointerBelongings.knotRelativeSizeAtFront / originalSpawnedPointerBelongings.knotAtDistanceX; knotWi * fromTry < originalSpawnedPointerBelongings.knotRelativeSizeAtFront; fromTry++) {
...
passThroughKnot && (spawnedPointerBelongings = draftFabrikk.spawnPointerBelongingsAtRectangle(/* keep */ /* y, x, z */ spawnedPointerBelongings.y, spawnedPointerBelongings.x, debPointer, /* radius, d, f, frontRatio */ radius, 0.9, 0.4, 1, /* keep */ /* debthScaleRatio, frontScaleRatio, profileScaleRatio */ 1 * 4 * 1.2, 1 * 2 * 1.4 * 1.2 * /* is it gorgylya? */ throughX, 1 * 2 * 1.7))
